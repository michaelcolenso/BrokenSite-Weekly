...
def not_mobile(html: str) -> CheckResult:
    return CheckResult("not_mobile", not parse_homepage(html).has_viewport, "homepage missing viewport meta" if not parse_homepage(html).has_viewport else "viewport meta present", 3)
